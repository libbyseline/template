...
library(gtExtras) # for initially understanding data -- > gt_plt_summary() function
...
skim()
```
I think this function does something very similar, but I'm experimenting with it
```{r}
gt_plt_summary()
```
